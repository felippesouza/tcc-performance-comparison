...
$targetRef = "ACM Transactions on Internet Technology 21(4): 1-28."
$selection.Find.Text = $targetRef
$selection.Find.Forward = $true
$selection.Find.Wrap = 1
$foundRef = $selection.Find.Execute()
if ($foundRef) {
    $selection.Collapse(0)
    $selection.TypeParagraph()
    $refText = "Jackson, J. 2024. pgx: PostgreSQL driver and toolkit for Go. Repositório oficial no GitHub. Disponível em: <https://github.com/jackc/pgx>. Acesso em: 31 ago. 2026."
